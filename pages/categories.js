...
setProperties([]);
    ...
    return (
        <Layout>
            ...
            <div className="flex gap-1">  {editedCategory&&(
                          <button 
                          type="button "
                          onClick={() =>{
                            setEditedCategory(null);
                ...
                <button type="submit" className="btn-primary py-1">Save</button></div>
           ...
           {categories.length > 0 && categories.map(category => (
               <tr key={category._id} >
                   ...
                   <td>
                       ...
                       <button className="btn-primary mr-2" onClick={() => editCategory(category)}>Edit</button>
